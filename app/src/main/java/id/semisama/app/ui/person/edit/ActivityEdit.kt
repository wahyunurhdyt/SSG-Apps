...
import id.semisama.app.databinding.ActivityEditBinding
import id.semisama.app.ui.ViewModelFactoryEdit
import id.semisama.app.ui.auth.verification.ActivityVerification
import id.semisama.app.utilily.*
import id.semisama.app.utilily.Constant.REQUEST_CAPTURE_PHOTO
import id.semisama.app.utilily.Constant.REQUEST_GALLERY_PHOTO
    ...
    private fun initObserver(){
        ...
        viewModel.apply {
            user.observe(owner) {
                ...
                if (isChangedEmail.value!!) {
                    launchNewActivity(ActivityVerification::class.java)
                    finish()
                }
            }
        }
